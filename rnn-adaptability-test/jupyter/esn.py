...
# test oil
# import pandas as pd
# BrentOilPrice = pd.read_csv(r'./csv/BrentOilPrices.csv', delimiter=',').values
# data0 = BrentOilPrice[:, 1].astype(np.cfloat)
# data = data0
...
plt.plot( Y.T, 'b' ,linestyle='dashed')
